...
@section('content')
    <div class="panel panel-primary panel-bordered">
        <div class="panel-heading clearfix">
            ...
            <div class="panel-actions">
                <a class="btn btn-default pull-right" href="{{ route('venues.index') }}">Back To All Stipulations</a>
            </div>
        </div>
    ...
    <div class="panel panel-bordered panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="icon fa-calendar"></i>List of Matches</h3>
        </div>
