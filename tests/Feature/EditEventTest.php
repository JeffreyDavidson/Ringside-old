...
class EditEventTest extends TestCase
{
    ...
    {
        $response = $this->actingAs($this->authorizedUser)->get(route('events.edit', $this->event->id));
    ...
    {
        $response = $this->actingAs($this->unauthorizedUser)->get(route('events.edit', $this->event->id));
