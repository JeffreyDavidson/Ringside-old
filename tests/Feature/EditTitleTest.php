...
class EditTitleTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->setupAuthorizedUser('edit-title');
    ...
    {
        $response = $this->actingAs($this->authorizedUser)->get(route('titles.edit', $this->title->id));
    ...
    {
        $response = $this->actingAs($this->unauthorizedUser)->get(route('titles.edit', $this->title->id));
    ...
    {
        $response = $this->actingAs($this->authorizedUser)->from(route('titles.edit', $this->title->id))->patch(route('titles.update', $this->title->id), $this->validParams([
            'name' => ''
        ]));
    ...
    public function editing_a_valid_title_with_matches()
    {
        ...
        $response = $this->actingAs($this->authorizedUser)->from(route('titles.edit', $this->title->id))->patch(route('titles.update', $this->title->id), [
            'name' => 'New Name',
            'slug' => 'new-slug',
            'introduced_at' => '2016-12-18'
        ]);
